            ...
            <div class="container">
                ...
                <div class="courses-category-wrapper">
                    ...
                    <ul class="category-menu">
                        ...
                        <li><a href="#">Les plus suivis</a></li>
                    </ul>
                </div>
                ...
                <div class="tab-content courses-tab-content">
                    <div class="tab-pane fade show active" id="tabs1">
                        ...
                        <div class="courses-wrapper">
                            <div class="row">
                            	<?php 
                            		foreach ($execution_req as $cours) {
                            			$rate = (int) $cours['vote'];
                            			$rate = $rate * 20;
                            			$rate = strval($rate); 
                            	...
                            	<div class="col-lg-4 col-md-6">
                                    ...
                                    <div class="single-courses">
                                        <div class="courses-images">
                                            <a href="cours-details.php?id_cours=<?php echo $cours['id_cours']; ?>"><img src="assets/images/courses/<?php echo $cours['img_cours']; ?>" alt="Courses"></a>
                                        </div>
                                        <div class="courses-content">
                                            <div class="courses-author">
                                                <div class="author">
                                                    <div class="author-thumb">
                                                        <a href="#"><img src="assets/images/author/<?php echo $cours['img_auteur']; ?>" alt="Author"></a>
                                                    </div>
                                                    <div class="author-name">
                                                        <a class="name" href="#"><?php echo $cours['nom_auteur']; ?></a>
                                                    </div>
                                                </div>
                                                <div class="tag">
                                                    <a href="#"><?php echo $cours['categorie']; ?></a>
                                                </div>
                                            </div>

                                            <h4 class="title"><a href="cours-details.php?id_cours=<?php echo $cours['id_cours']; ?>"><?php echo $cours['nom_cours']; ?></a></h4>
                                            <div class="courses-meta">
                                                <span> <i class="icofont-clock-time"></i> <?php echo $cours['duree']; ?></span>
                                                <span> <i class="icofont-read-book"></i>  <?php echo $cours['nombre_etudiant']; ?> </span>
                                            </div>
                                            <div class="courses-price-review">
                                                <div class="courses-price">
                                                    <span class="sale-parice"><?php echo $cours['prix']; ?></span>
                                                    <?php 
                                                    	if ($cours['ancien_prix'] != '0') {
                                                    		echo '<span class="old-parice">'.$cours['ancien_prix'].'</span>';
                                                    	}
                                                     ?>
                                                    
                                                </div>
                                                <div class="courses-review">
                                                    <span class="rating-count"><?php echo $cours['vote']; ?></span>
