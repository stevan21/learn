...
<head>
    ...
    <title>A propos de nous - stevan-Educ</title>
        ...
        <div class="section page-banner">
            ...
            <div class="container">
                ...
                <div class="page-banner-content">
                    ...
                    <h2 class="title">A propos de <span>stevan-Educ.</span></h2>
                </div>
                <!-- Page Banner End -->
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="about-images">
                                ...
                                <div class="about-years">
                                    ...
                                    <p>Plus de<strong> 7</strong>années d'experience</p>
                                </div>
                            </div>
                            <!-- About Images End -->
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="about-content">
                                <h5 class="sub-title">Bienvenue à stevan-Educ.</h5>
                                <h2 class="main-title">Vous pouvez rejoindre stevan-Educ et améliorer vos compétences pour votre <span>brillant avenir.</span></h2>
                                <a href="#" class="btn btn-primary btn-hover-dark">Commencez un cours</a>
                            </div>
                            <!-- About Content End -->
                                ...
                                <div class="about-item">
                                    <div class="item-icon-title">
                                        <div class="item-title">
                                            <h3 class="title">Meilleurs instructeurs</h3>
                                        </div>
                                    </div>
                                    <p>Des experts de différents domaines à vos côtés pour vous accompagner dans votre processus de formation.</p>
                                    <p>Ils sont à votre écoute pour vos différents problèmes et pour vous aider à donner le meilleurs de vous même.</p>
                                </div>
                                <!-- About Item End -->
                            </div>
                            <div class="col-lg-4">
                                ...
                                <div class="about-item">
                                    <div class="item-icon-title">
                                        <div class="item-title">
                                            <h3 class="title">Meilleurs programmes</h3>
                                        </div>
                                    </div>
                                    <p>Des programmes très bien conçus pour vous aider à réaliser vos projets de formation dans de bonnes conditions.</p>
                                    <p>Des cours très bien détaillés et facile à comprendre pour vous faire comprendre facilement les notions.</p>
                                </div>
                                <!-- About Item End -->
                            </div>
                            <div class="col-lg-4">
                                ...
                                <div class="about-item">
                                    <div class="item-icon-title">
                                        <div class="item-title">
                                            <h3 class="title">Amélioration rapide</h3>
                                        </div>
                                    </div>
                                    <p>Nos formations vous permettent de rapidement assimiler les notions et d'être prêts à relever différents défis.</p>
                                    <p>Nos formations sont sonctionnées d'un certificat valabre et qui vous mettent rapidement sur le marché du travail.</p>
                                </div>
                                <!-- About Item End -->
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6">
                            <div class="call-to-action-btn">
                                <a class="btn btn-primary btn-hover-dark" href="contact.php">Information de dépôt</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="section section-padding mt-n1">
            <div class="container">
                ...
                <div class="section-title shape-03 text-center">
                    <h5 class="sub-title">Membres de l'équipe</h5>
                    <h2 class="main-title"><span>Instructeurs </span>qualifiés</h2>
                </div>
                <!-- Section Title End -->
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="single-testimonial swiper-slide">
                                ...
                                <div class="testimonial-content">
                                    <p>Je suis très content d'être sur cette plateforme d'e-learning. Elle est différente des autres. Le service client est dynamique et répond à toutes vos préoccupations dans les plus brefs délais. Leurs prix sont à la portée de tout le monde.</p>
                                    <h4 class="name">Judicael SETTOSSI</h4>
                                    <span class="designation">PDG Vulcain-Tech, cameroun</span>
                                </div>
                            </div>
                            ...
                            <div class="single-testimonial swiper-slide">
                                ...
                                <div class="testimonial-content">
                                    <p>Je suis très content d'être sur cette plateforme d'e-learning. Elle est différente des autres. Le service client est dynamique et répond à toutes vos préoccupations dans les plus brefs délais. Leurs prix sont à la portée de tout le monde.</p>
                                    <h4 class="name">Michel GBAGUIDI</h4>
                                    <span class="designation">Designer, cameroun</span>
                                </div>
                            </div>
                            <!-- Single Testimonial End -->
                            ...
                            <div class="single-testimonial swiper-slide">
                                ...
                                <div class="testimonial-content">
                                    <p>Je suis très contente d'être sur cette plateforme d'e-learning. Elle est différente des autres. Le service client est dynamique et répond à toutes vos préoccupations dans les plus brefs délais. Leurs prix sont à la portée de tout le monde.</p>
                                    <h4 class="name">Sarah BISSIROU</h4>
                                    <span class="designation">Designer, cameroun</span>
                                </div>
                            </div>
                            <!-- Single Testimonial End -->
