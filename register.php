...
if (!empty($_POST)) {
	...
	if (isset($_POST['register'])) {
		...
		if (!isset($nom)) {
			$err_nom = "Veuillez remplir ce champs!";
			$valide = false;
		}
		if (!isset($mail)) {
		...
		if (!isset($password)) {
			$err_password = "Veuillez remplir ce champs!";
			$valide = false;
		}
		if (!isset($repass)) {
		...
		if ($valide) {
			$password = "!light".$password."team!".$password.'teamlight';
			$requete = "INSERT INTO student (nom, mail, password) VALUES ('$nom', '$mail', '$password')";
...
<head>
    ...
    <title>Inscription - stevan-Educ</title>
        ...
        <div class="section page-banner">
            ...
            <div class="container">
                ...
                <div class="page-banner-content">
                    ...
                    <h2 class="title"><span>Formulaire</span> d'inscription</h2>
                </div>
                <!-- Page Banner End -->
            </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="register-login-form">
                                <h3 class="title">S'inscrire <span>maintenant</span></h3>
                                ...
                                <div class="form-wrapper">
                                    <form action="" method="post">
                                        ...
                                        <!-- Single Form Start -->
                                        <div class="single-form">
                                            <button class="btn btn-primary btn-hover-dark w-100" name="register" >Inscription</button>
                                        </div>
                                        <!-- Single Form End -->
                                    </form>
                                </div>
