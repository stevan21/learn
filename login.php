...
if (!empty($_POST)) {
    ...
    if (isset($_POST['login'])) {
        ...
        if ($valide) {
            ...
            $req = "SELECT * FROM student WHERE mail = '".$mail."' AND password = '".$password."'";
...
<head>
    ...
    <title>Connexion - stevan-Educ</title>
                            ...
                            <div class="register-login-form">
                                ...
                                <div class="form-wrapper">
                                    <form action="" method="post">
                                        ...
                                        <!-- Single Form Start -->
                                        <div class="single-form">
                                            <button name="login" class="btn btn-primary btn-hover-dark w-100">Connexion</button>
                                        </div>
                                        <!-- Single Form End -->
                                        <!-- Single Form Start -->
                                        <div class="single-form">
                                            <a href="forgot.php" style="text-align: center;"><b>Mot de passe oublié?</b></a>
                                        </div>
                                        <!-- Single Form End -->
                                    </form>
                                </div>
